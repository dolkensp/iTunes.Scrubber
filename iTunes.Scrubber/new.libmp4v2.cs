...
namespace iTunes.Scrubber
{
    public static class libmp4v2
    {
        ...
        {
            imports.VBMP4SetMOVI(buffer, hFile.Value);
        }

        public static void MP4SetCoverArt([In] Byte[] buffer, [In] Int32 length)
        {
            imports.VBMP4SetCoverArt(buffer, length);
        }
        ...
        public static void MP4TagsSetTrack([In] MP4Tags tags, [In] Int16? trackNo)
        {
            ...
            if (trackNo.HasValue)
            {
                ...
                ptr2[0].index = new UInt16(trackNo.Value);
                ptr2[0].total = new UInt16(trackNo.Value);
            }
            else
        ...
        public static void MP4TagsSetTVEpisode([In] MP4Tags tags, [In] Int32? episodeNo)
        {
            ...
            if (episodeNo.HasValue)
            {
                ...
                ptr2[0] = new UInt32(episodeNo.Value);
            }
            else
        ...
        public static void MP4TagsSetTVSeason([In] MP4Tags tags, [In] Int32? seasonNo)
        {
            ...
            {
                ptr2 = new ArrayPtr<UInt32>(1);
                ptr2[0] = new UInt32(seasonNo.Value);
            } else 
                ptr2 = new ArrayPtr<UInt32>();
        ...
        internal static class imports
        {
            ...
            [DllImport("libmp4v2.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode, ExactSpelling = true)]
            internal static extern IntPtr MP4Modify([In] IntPtr fileName, [In] UInt32 verbosity, [In] UInt32 flags);
            [return: MarshalAs(UnmanagedType.I1)]
            [DllImport("libmp4v2.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode, ExactSpelling = true)]
            ...
            [DllImport("MP4V2VBWrapper.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
            internal static extern void VBMP4SetCoverArt(byte[] buff, int len);

            [DllImport("MP4V2VBWrapper.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
