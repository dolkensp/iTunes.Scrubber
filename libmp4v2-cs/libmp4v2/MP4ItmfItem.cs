namespace libmp4v2
{
    ...
    public sealed class MP4ItmfItem : StructPtr<libmp4v2.Internal.MP4ItmfItem_s>
    {
        public MP4ItmfItem()
        {
        }

        public MP4ItmfItem(libmp4v2.Internal.MP4ItmfItem_s value) : base(value)
        {
        }

        internal MP4ItmfItem(StructPtr<libmp4v2.Internal.MP4ItmfItem_s> other) : base(other)
        {
        }
        ...
        public MP4ItmfItem(int arraySize) : base(arraySize)
        {
        }

        public MP4ItmfItem(IntPtr value) : base(value)
        {
        }

        protected override StructPtr<libmp4v2.Internal.MP4ItmfItem_s> CreateInstance(IntPtr pointer)
        {
            return new MP4ItmfItem(pointer);
        }

        public static implicit operator MP4ItmfItem(libmp4v2.Internal.MP4ItmfItem_s value)
        {
            return new MP4ItmfItem(value);
        }

        public static implicit operator MP4ItmfItem(IntPtr value)
        {
            return new MP4ItmfItem(value);
        }
        ...
        public MP4ItmfItem this[int index]
        {
            get
            {
                return (MP4ItmfItem) base.GetAtIndex(index);
            }
        }
