namespace libmp4v2
{
    ...
    public sealed class MP4Tags : StructPtr<libmp4v2.Internal.MP4Tags_s>
    {
        public MP4Tags()
        {
        }

        public MP4Tags(libmp4v2.Internal.MP4Tags_s value) : base(value)
        {
        }

        internal MP4Tags(StructPtr<libmp4v2.Internal.MP4Tags_s> other) : base(other)
        {
        }
        ...
        public MP4Tags(int arraySize) : base(arraySize)
        {
        }

        public MP4Tags(IntPtr value) : base(value)
        {
        }

        protected override StructPtr<libmp4v2.Internal.MP4Tags_s> CreateInstance(IntPtr pointer)
        {
            return new MP4Tags(pointer);
        }

        public static implicit operator MP4Tags(libmp4v2.Internal.MP4Tags_s value)
        {
            return new MP4Tags(value);
        }

        public static implicit operator MP4Tags(IntPtr value)
        {
            return new MP4Tags(value);
        }
        ...
        public MP4Tags this[int index]
        {
            get
            {
                return (MP4Tags) base.GetAtIndex(index);
            }
        }
